...
function panelStrings(): Record<string, string> {
    return {
        ...
        jwtValid: vscode.l10n.t('Valid'),
        jwtNotYetValid: vscode.l10n.t('Not valid yet'),
        jwtIssuer: vscode.l10n.t('Issuer'),
        jwtSubject: vscode.l10n.t('Subject'),
        jwtAudience: vscode.l10n.t('Audience'),
        jwtIssued: vscode.l10n.t('Issued'),
        jwtNotBefore: vscode.l10n.t('Not before'),
        jwtHeader: vscode.l10n.t('Header'),
        jwtPayload: vscode.l10n.t('Payload'),
        jwtCopyToken: vscode.l10n.t('Copy token'),
        jwtCopyDecoded: vscode.l10n.t('Copy decoded JSON'),
        ...
        headerValue: vscode.l10n.t('Header value'),
        revealValue: vscode.l10n.t('Show value'),
        hideValue: vscode.l10n.t('Hide value'),
        authSends: vscode.l10n.t('Sends'),
        authSendsNothing: vscode.l10n.t('No Authorization header is sent.'),
